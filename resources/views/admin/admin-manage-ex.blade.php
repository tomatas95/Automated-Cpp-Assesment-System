...
<body>
        ...
        <div class="row align-items-center px-3">
            <div class="col-md-6 text-center text-md-left mt-5">
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div>
                        <span class="dashboard-greeting">{{ __("Welcome") }}, @auth<strong>{{ $user->name }}</strong></span>@endauth
                    </div>
                </div>
    ...
    <div class="col-12 my-4">
        <div class="d-flex justify-content-center">
            @include('partials._search', ['action' => "/admin/exercises/manage/{$user->id}"], ['placeholder' => __("Search created exercises...")])
        </div>
