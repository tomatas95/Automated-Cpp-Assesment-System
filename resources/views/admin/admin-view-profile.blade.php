...
<head>
    ...
    @vite(['resources/sass/profile-styles.scss', 'resources/sass/layouts/footer.scss', 'resources/sass/layouts/navbar.scss', 'resources/sass/graph-styles.scss',  'resources/sass/hamburger-styles.scss', 'resources/js/responsive-btn-layout-change.js', 'resources/js/navbar-dropdown-toggle.js'  ,'resources/js/hamburger-menu.js', 'resources/js/activity-graph.js'])
    ...
    <div class="bg-profile p-5 rounded">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url("/admin/profile/edit/{$user->id}") }}" id="editBtn" class="btn btn-profile"><i class="fas fa-pen"></i> {{ __("Edit") }}</a>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ url("/admin/exercises/manage/{$user->id}") }}" id="createdExBtn" class="btn btn-profile"><i class="fas fa-tasks"></i> {{ __("Created Exercises") }}</a>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-md-6 mb-3 d-flex justify-content-between align-items-center">
        ...
        <div class="legend">
            <div class="pretty p-svg p-smooth created-checkbox">
                <label class="position-relative" for="createdExercises">
                    <input type="checkbox" class="legend-checkbox" id="createdExercises" checked onclick="toggleSeries(this)" value="{{ __("Created Exercises") }}">
            ...
            <div class="pretty p-svg p-smooth submitted-checkbox">
                <label class="position-relative" for="submittedExercises">
                    <input type="checkbox" class="legend-checkbox" id="submittedExercises" checked onclick="toggleSeries(this)" value="{{ __("Submitted Exercises") }}">
