...
<head>
    ...
    @vite(['resources/sass/profile-styles.scss', 'resources/sass/layouts/footer.scss', 'resources/sass/layouts/navbar.scss', 'resources/js/profile-edit-env.js', 'resources/sass/hamburger-styles.scss', 'resources/js/navbar-dropdown-toggle.js'  ,'resources/js/hamburger-menu.js', 'resources/js/register-live-validation.js'])
...
<div class="container mt-5">
    <div class="bg-profile p-5 rounded">
        ...
        <form method="POST" id="profileEdit" action="/users/my-profile/users/{{ auth()->user()->id }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
           ...
           <div class="form-group mt-4">
            ...
            <div class="form-group mt-4">
                ...
                <input type="text" class="form-control" id="skills" name="skills" placeholder="{{ __("List some of your skills...") }}" value="{{$user->skills }}">
            ...
            <div class="text-center mt-4">
                <button id="submit-profile-btn" type="submit" class="btn px-5 py-2 btn-save btn-lg">{{ __("Save") }}</button>
            </div>
        </form>
    </div>
</div>
